		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						角色管理 <small><span class="help-inline">角色编辑</small>
					</h3>
						...
						<tr>
							...
							<td colspan="3" width="85%" class="pn-fcontent">
								<div class="perm-container">
									...
									<div class="perm-layout-1">
										 <label><input  value="/sys"  type="checkbox" name="perms">资讯管理</label>
									 ...
									 <div class="perm-layout-1">
										 <label><input  value="/sys4"  type="checkbox" name="perms">合作机构管理</label>
										 <div class="perm-layout-2">
										        <label><input   value="/s004"  type="checkbox" name="perms">信息管理</label>
										 </div>
									 </div>
									 <div class="perm-layout-1">
										 <label><input  value="/sys3"  type="checkbox" name="perms">友情链接管理</label>
										 <div class="perm-layout-2">
									...
									<div class="perm-layout-1">
									        <label><input  value="/sys9"  type="checkbox" name="perms">系统管理</label>
										    <div class="perm-layout-2">
												<label><input   value="/u001"   type="checkbox" name="perms">用户管理</label>
												<label><input   value="/u002"   type="checkbox" name="perms">角色管理</label>
												<label><input   value="/s005"   type="checkbox" name="perms">导航菜单管理</label>
										     </div>
									</div>
