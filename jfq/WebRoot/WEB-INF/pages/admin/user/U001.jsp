...
<body class="page-header-fixed">
	...
	<div class="page-container">
		...
		jQuery(document).ready(function() {
			...
			$('#sys9_sub_menu').show();
		     loadUrlPage(0, 'h/u001_', 'list', 'a_div_info_list_');
			});
			// 分页查询
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						用户管理 <small><span class="help-inline">用户列表</small>
					</h3>
			...
			<c:if test="${msg!=null}">
							...
							<div class=" btn btn-toolbar">
								<a href="${basePath}/h/u001_edit.ac?flag=add" class="btn btn-primary"><i class="fa "></i> 新增</a>
							</div>
			<!-- BEGIN PAGE CONTENT-->
			<div class="row">
				<div id="msg"></div>
