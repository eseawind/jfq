		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						合作机构管理  <small><span class="help-inline">展示所有</span></small>
					</h3>
				...
				<div class="col-md-12">
					<div class="matter">
						...
						<div class="btn btn-toolbar">
							<a href="${basePath}/h/s004_edit.ac" class="btn btn-primary">新增</a>
						</div>
						<table class="table table-condensed table-striped">
							...
							<c:forEach items="${beans}" var="bean">
								<tr>
									...
									<td c><a href="${basePath}/h/s004_edit.ac?id=${bean.id}" class="btn edit green">编辑</a>
										<a href="javascript:void(0)"   class="btn btn-danger" 
											onclick="if(confirm('确认删除吗?')){location.href='${basePath}/h/s004_del.ac?id=${bean.id}'};"
											rel="nofollow">删除</a>
									</td>
								</tr>
							</c:forEach>
						...
						<customtag:pagingext func="loadUrlPage" params="'h/s004_','init'" />
					</div>
				</div>
			</div>
			<!-- END PAGE CONTENT-->
